...
func (c *CoreV1alphaClient) TunnelPeerOffers() TunnelPeerOfferInterface {
	return newTunnelPeerOffers(c)
}
...
// NewForConfigAndClient creates a new CoreV1alphaClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CoreV1alphaClient, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
