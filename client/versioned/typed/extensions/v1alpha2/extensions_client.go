...
// NewForConfigAndClient creates a new ExtensionsV1alpha2Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ExtensionsV1alpha2Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &ExtensionsV1alpha2Client{client}, nil
}

// NewForConfigOrDie creates a new ExtensionsV1alpha2Client for the given config and
...
func New(c rest.Interface) *ExtensionsV1alpha2Client {
	return &ExtensionsV1alpha2Client{c}
}
