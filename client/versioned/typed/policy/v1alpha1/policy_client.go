...
// PolicyV1alpha1Client is used to interact with features provided by the policy.apoxy.dev group.
type PolicyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PolicyV1alpha1Client) RateLimits() RateLimitInterface {
